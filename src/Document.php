...
abstract class Document implements DBObject {
	...
	*/
	...
	public static function getByID($id) {
		return MDB::getInstance()->getObjectByID(static::class,$id);
	}
	...
	public static function getManyByKey($key, $value) {
		return MDB::getInstance()->getObjectsByKey(static::class, $key, $value);
	}
	...
	public static function getOneByKey($key, $value) {
		return MDB::getInstance()->getObjectByKey(static::class, $key, $value);
	}
